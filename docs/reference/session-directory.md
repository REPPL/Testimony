...
| `mode` | string | no | `A` (testing your own application) or `B` (reference capture of a third-party app — see "Coming next" in [`README.md`](../../README.md)), default `A`; only Mode A is produced today |
